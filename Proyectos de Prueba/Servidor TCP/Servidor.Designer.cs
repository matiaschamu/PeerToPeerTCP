...
namespace Servidor_TCP
{
    partial class Servidor
    {
        ...
        private void InitializeComponent()
        {
			...
			// peerToPeerTcp1
			// 
			this.peerToPeerTcp1.EndPointRemoto = null;
			this.peerToPeerTcp1.PuertoEscucha = ((ushort)(80));
			this.peerToPeerTcp1.ReConexionAutomatica = false;
			this.peerToPeerTcp1.ReListenAutomatico = false;
			this.peerToPeerTcp1.TestearConexion = true;
			this.peerToPeerTcp1.TiempomSegTestConexion = 2000;
			this.peerToPeerTcp1.ConexionEstablecida += new PeerToPeer.Tcp.PeerToPeerTcp.ConexionEventHandler(this.clienteServidorTCP_UDP1_ConexionEstablecida);
			this.peerToPeerTcp1.ConexionCancelada += new PeerToPeer.Tcp.PeerToPeerTcp.ConexionEventHandler(this.clienteServidorTCP_UDP1_ConexionCancelada);
			this.peerToPeerTcp1.EscuchaIniciada += new PeerToPeer.Tcp.PeerToPeerTcp.ConexionEventHandler(this.clienteServidorTCP_UDP1_EscuchaIniciada);
			this.peerToPeerTcp1.EscuchaIniciando += new PeerToPeer.Tcp.PeerToPeerTcp.ConexionEventHandler(this.clienteServidorTCP_UDP1_EscuchaIniciando);
			this.peerToPeerTcp1.EscuchaCancelada += new PeerToPeer.Tcp.PeerToPeerTcp.ConexionEventHandler(this.clienteServidorTCP_UDP1_EscuchaCancelada);
			this.peerToPeerTcp1.DatosRecibidos += new PeerToPeer.Tcp.PeerToPeerTcp.ConexionEventHandler(this.clienteServidorTCP_UDP1_DatosRecibidos);
		...
		private PeerToPeer.Tcp.PeerToPeerTcp peerToPeerTcp1;
